...
API Routes
Your project includes several API routes:

[GET] /api/hello: Returns a basic greeting. Editable in pages/api/hello.js.
[GET] /api/user-info: Returns mock user data based on query parameters. Editable in pages/api/user-info.js.
[GET] /api/calculate: Provides calculation services. Editable in pages/api/calculate.js.
[GET] /api/search: Allows searching of data. Editable in pages/api/search.js.
[GET] /api/user: Returns user-related information. Editable in pages/api/user.js.
These API endpoints are located in the pages/api directory and are mapped to /api/*.
